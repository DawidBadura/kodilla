...
public class FlightsService {
    ...
    List<Flight>flySearcher(String depCity, String arrCity, String midCity){
        List<Flight>flightsFrom= flySearcher(depCity,midCity);
        List<Flight>flightsTo= flySearcher(midCity,arrCity);

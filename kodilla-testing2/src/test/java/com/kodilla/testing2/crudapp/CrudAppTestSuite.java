...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://dawidbadura.github.io";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("dawid.badurakrk@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Smerf123");
    ...
    private void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        ...
        WebElement del = driver.findElement(By.xpath(
                "//*[contains(text(),'"+ taskName +"')]//ancestor::form//button[contains(text(), 'Delete')]"));
        del.click();
